...
Target1=[succ21;succ31;succ41];
Target2=[prec12;succ32;succ42];
Target3=[prec13;prec23;succ43];
Target4=[prec14;prec24;prec34];
...
reldif= { Target1, Target2, Target3, Target4 };
...
for j=1:4
    ...
    stem(sorted_influencer(:,1),smooth_error,'Markersize', 0.0000000001, 'Color',[.15, .55, .90, .6]) %%% SMOOTHED DATA
   ...
   %%%% PLOT SUBPLOT DESCRIPTIVES + AXIS
    ...
    sgtitle('SD Effects per Target', 'FontName', 'Times New Roman')
end
    

%%%%% SAVE PLOT AS PNG IMAGE
b=gcf;
exportgraphics(b,'Seperate_Targets.png','Resolution',720);
