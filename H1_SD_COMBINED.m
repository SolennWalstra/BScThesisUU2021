...
annotation('textbox',[0.34 0.72 0.9 0.1],'String','Actual Amplitude Difference','EdgeColor','none', "FontName", "Times New Roman", "FontSize", 6)
...
%%% plot labels
title("Forward Serial Dependence")
...
%%% plot labels
title("Backward Serial Dependence")
ylabel("Response error (°)", 'FontSize', 8)
xlabel("Relative distance influencer-target (°)", 'FontSize', 8)
axis("square")
axis([-100 100 -10 10])
