...
Distance1=[prec12;prec23;prec34;succ21;succ32;succ43];
Distance2=[prec13;prec24;succ31;succ42];
Distance3=[prec14;succ41];

Err1=[err2;err3;err4;err1;err2;err3];
Err2=[err3;err4;err1;err2];
Err3=[err4;err1];



reldif=        { Distance1, Distance2, Distance3   };
errseperate =  { Err1,    Err2,    Err3    };
...
for j=1:3
    ...
    stem(sorted_influencer(:,1),smooth_error,'Markersize', 0.0000000001, 'Color',[1 0.9 0 .6]) %%% SMOOTHED DATA
   ...
   %%%% PLOT SUBPLOT DESCRIPTIVES + AXIS
    ...
    if j<5
        caption = sprintf('Distance = %d',j);
        title(caption, 'FontSize', 9);
    end
    
    
    %%%%% OVERALL PLOT TITLE + annotation for significance
    annotation('textbox',[0.12 0.4 0.9 0],'String','Note: *p<.05  **p<.001','EdgeColor','none', "FontName", "Times New Roman", "FontSize", 8)
    sgtitle('SD Effects per Distance', 'FontName', 'Times New Roman')
end
    

%%%%% SAVE PLOT AS PNG IMAGE
b=gcf;
exportgraphics(b,'Distance_Effects.png','Resolution',720);
