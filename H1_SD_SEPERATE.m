...
for j=1:16
    ...
    if j==1| j==6|j==11|j==16
        ...
        plot(xvel2,yvel,'k');
            if j<5
                caption = sprintf('Influencer %d',j);
...
annotation('textbox', [0.04,0,.5,.84], 'String','Target 1', 'EdgeColor','none', "FontName", "Times New Roman",'fontweight','bold', "FontSize", 9);
annotation('textbox', [0.04,0,.5,.63], 'String','Target 2', 'EdgeColor','none', "FontName", "Times New Roman",'fontweight','bold', "FontSize", 9);
annotation('textbox', [0.04,0,.5,.42], 'String','Target 3', 'EdgeColor','none', "FontName", "Times New Roman",'fontweight','bold', "FontSize", 9);
annotation('textbox', [0.04,0,.5,.21], 'String','Target 4', 'EdgeColor','none', "FontName", "Times New Roman",'fontweight','bold', "FontSize", 9);

    
    %%%%% OVERALL PLOT TITLE + annotation for significance
    annotation('textbox',[0.14 0.05 0.9 0],'String','Note: *p<.05  **p<.001','EdgeColor','none', "FontName", "Times New Roman", "FontSize", 8)
